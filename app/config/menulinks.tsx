// Este archivo ahora exporta desde @menulinks.tsx para mantener compatibilidad

import React from "react";

// Configuración de posición del logo (true = centrado, false = izquierda)
const LOGO_CENTERED = false;
...
export const socialConfig: SocialConfig = {
  showInNavbar: SHOW_SOCIAL_IN_NAVBAR,
  showInFooter: SHOW_SOCIAL_IN_FOOTER,
  links: [
    {
      platform: "Facebook",
