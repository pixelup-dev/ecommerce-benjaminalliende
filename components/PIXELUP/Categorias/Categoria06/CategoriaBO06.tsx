          ...
          <div className="2xl:mx-auto 2xl:container py-12 px-4 sm:px-6 xl:px-20 2xl:px-0 w-full">
            <div className="flex flex-col jusitfy-center items-center space-y-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-x-8 w-full">
                ...
                <div className="relative group flex justify-center items-center h-full w-full">
                  {getOrderedBanners()[0] && (
                    <div className="relative w-full">
                      <img 
                        className={`object-center object-cover h-[600px] w-full ${!getOrderedBanners()[0].isDefault ? 'opacity-100' : 'opacity-40'}`}
                        style={{ borderRadius: 'var(--radius)' }}
                        src={getOrderedBanners()[0].mainImage.url}
                        alt={getOrderedBanners()[0].title}
                      />
                      ...
                      <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2">
                        <span className="text-base font-medium text-foreground py-3 w-36 bg-secondary text-center inline-block" style={{ borderRadius: 'var(--radius)' }}>
                          {getOrderedBanners()[0].title}
                        </span>
                      </div>
                    </div>
                  )}
                  ...
                  {[1, 2].map((index) => (
                    <div key={index} className="relative group flex justify-center items-center h-full w-full">
                      {getOrderedBanners()[index] && (
                        <div className="relative w-full">
                          <img 
                            className={`object-center object-cover h-[280px] w-full ${!getOrderedBanners()[index].isDefault ? 'opacity-100' : 'opacity-40'}`}
                            style={{ borderRadius: 'var(--radius)' }}
                ...
                {/* Cuarta imagen */}
                <div className="relative group flex justify-center items-center h-full w-full hidden lg:flex">
                  {getOrderedBanners()[3] && (
                    <div className="relative w-full">
                      <img 
                        className={`object-center object-cover h-[600px] w-full ${!getOrderedBanners()[3].isDefault ? 'opacity-100' : 'opacity-40'}`}
                        style={{ borderRadius: 'var(--radius)' }}
                        src={getOrderedBanners()[3].mainImage.url}
                        alt={getOrderedBanners()[3].title}
                      />
                      <div className="absolute top-4 left-4 bg-primary text-white px-3 py-1 rounded-full">
