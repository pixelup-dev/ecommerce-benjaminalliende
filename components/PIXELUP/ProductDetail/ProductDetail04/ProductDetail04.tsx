...
interface ProductDetail04Props {
  product: any;
}

const ProductDetail04: React.FC<ProductDetail04Props> = ({
          ...
          <div className="flex flex-col lg:flex-row ">
            <div className="md:flex-1 px-4">
              ...
              <div className="flex flex-row items-start justify-center">
                ...
                <div
                  className=" hidden w-full md:w-[500px] md:h-[500px] bg-gray-100 md:flex items-center justify-center shadow-md"
...
export default ProductDetail04;
