      ...
      <div className="flex flex-col gap-4">
        <div className=" ">
          <div className="rounded-lg ">
            <section>
              <div className="flex items-center max-md:flex-col text-black px-6 py-2 rounded">
                <h1 className="text-left text-3xl font-semibold text-black sm:text-4xl w-full">
