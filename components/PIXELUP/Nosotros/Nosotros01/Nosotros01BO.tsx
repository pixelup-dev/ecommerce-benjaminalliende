  ...
  {/*             <div className="text-center mb-16">
                  ...
                  <div className={`grid grid-cols-1 ${
                    ...
                    {getVisibleTestimonials().map((banner, index) => (
                      ...
                      >
                        ...
                        <div className="p-5">
                          <h3 className="text-lg text-[#5B488E] mb-1">
                            {banner.title}
                          </h3>
                          <p className="text-xs text-[#81C4BA] font-semibold mb-2 uppercase tracking-wide">
                            {banner.buttonLink}
                          </p>
            ...
            <div className="my-8">
              <div className={`${bannerData.length <= 1 ? '' : 'flex gap-4'}`}>
                ...
                >
                  {isAddingImage ? "Cancelar" : "Agregar Persona"}
                </button>
                {bannerData.length > 1 && (
                  <button
                    type="button"
            ...
            <form onSubmit={handleSubmit} className="mt-8 bg-white p-6 rounded-lg shadow">
              ...
              />
                <h3 className="font-normal text-primary">
                Profesión <span className="text-primary">*</span>
              </h3>
              <input
                type="text"
                name="buttonLink"
              ...
              />
              <h3 className="font-normal text-primary">
                Detalle <span className="text-primary">*</span>
              </h3>
              <input
                type="text"
                name="landingText"
                ...
                className="shadow block w-full px-4 py-3 mt-2 mb-4 border border-gray-300 rounded-md"
                placeholder="Detalle de la profesión"
              />
