...
const Hero04Preview = () => {
  ...
  return (
    <section className="w-full bg-gray-100">
      <div className="max-w-6xl mx-auto w-full px-4 md:px-0 py-8 lg:py-24 flex flex-col lg:flex-row items-center justify-center">
        {/* Contenedor de imagen */}
        <div className="flex w-full md:flex-1 items-center justify-center mt-6 lg:mt-0 lg:order-2">
          <img
        ...
        {/* Contenedor de texto */}
        <div className="w-full md:flex-1 flex flex-col items-center text-center lg:items-start lg:text-left lg:order-1 mt-4 md:mt-8 lg:mt-0">
