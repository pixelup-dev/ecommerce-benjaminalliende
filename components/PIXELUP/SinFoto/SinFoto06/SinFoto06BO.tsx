...
function SinFoto06BO() {
  ...
  const handleSubmitMarquee = async (
    ...
    try {
      setLoading(true);
      const bannerId = `${process.env.NEXT_PUBLIC_SINFOTO06_CONTENTBLOCK}`;
                      ...
                      <div className="relative bg-white p-8 rounded-2xl shadow-lg">
                        <div className="space-y-4">
                          ...
                          <div className="space-y-2">
                            <span className="text-[#EB4F5D] font-semibold text-base block">
                          ...
                          <span className="text-gray-600 leading-snug text-lg">
                    ...
                    <div className="relative col-span-1">
                      <div className="grid grid-cols-1 gap-4">
                        <div className="bg-white shadow-lg p-6 rounded-xl">
                          <div className="w-12 h-12 bg-[#2F3C69] rounded-lg flex items-center justify-center mb-4">
                            <svg
                          ...
                          <h3 className="font-semibold text-gray-900 mb-2">
                            {marqueeData.contentText.porcentaje}
                          </h3>
                          <p className="text-sm text-gray-600">
                            {marqueeData.contentText.textoPorcentaje}
                          </p>
                        </div>
                        <div className="bg-white shadow-lg p-6 rounded-xl">
                          <div className="w-12 h-12 bg-[#2F3C69] rounded-lg flex items-center justify-center mb-4">
                          ...
                          <h3 className="font-semibold text-gray-900 mb-2">
                            {marqueeData.contentText.tiempoTitulo}
                          </h3>
                          <p className="text-sm text-gray-600">
                            {marqueeData.contentText.tiempoTexto}
                          </p>
                        </div>
                      </div>
                    </div>
