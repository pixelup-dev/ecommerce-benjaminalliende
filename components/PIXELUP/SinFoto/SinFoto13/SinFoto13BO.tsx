...
const SinFoto13BO: React.FC = () => {
  ...
  const [formData, setFormData] = useState<ContentData>({
    ...
    titulo: "",
    contenido: "",
    box1: { title: "", contentText: "", icon: "Sprout" },
    box2: { title: "", contentText: "", icon: "Star" },
    box3: { title: "", contentText: "", icon: "ShieldCheck" },
    textoBoton: "",
    linkBoton: "",
  });
              ...
              <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                  ...
                  <div className="text-center relative">
                    <div className="flex justify-center mb-4">
                      <div className="h-16 w-16 bg-primary rounded-full shadow-md flex items-center justify-center">
                        {renderIcon(formData.box1.icon || "Sprout", "text-2xl text-white")}
                      </div>
                    </div>
                  ...
                  <div className="text-center relative">
                    <div className="flex justify-center mb-4">
                      <div className="h-16 w-16 bg-primary rounded-full shadow-md flex items-center justify-center">
                        {renderIcon(formData.box2.icon || "Star", "text-2xl text-white")}
                      </div>
                    </div>
                    <h3 className="font-oldStandard text-xl mb-2">
                      {formData.box2.title}
                  ...
                  <div className="text-center">
                    <div className="flex justify-center mb-4">
                      <div className="h-16 w-16 bg-primary rounded-full shadow-md flex items-center justify-center">
                        {renderIcon(formData.box3.icon || "ShieldCheck", "text-2xl text-white")}
                      </div>
                    </div>
                    <h3 className="font-oldStandard text-xl mb-2">
                      {formData.box3.title}
