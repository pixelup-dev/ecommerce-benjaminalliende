      ...
      <div className="mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-8 md:mb-16 text-gray-800">
            {contentData.title || "Título Principal"}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
            {[contentData.box1, contentData.box2, contentData.box3, contentData.box4, contentData.box5, contentData.box6].map((box, index) => (
                ...
                <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4">{box.title}</h3>
                <p className="text-sm md:text-base text-gray-600">{box.contentText}</p>
              </div>
            ))}
          </div>
        </div>
