  ...
  const fetchData = async () => {
    try {
      ...
      const imagesResponse = await axios.get(
        `${process.env.NEXT_PUBLIC_API_URL_CLIENTE}/api/v1/banners/${process.env.NEXT_PUBLIC_GALERIA02_IMGID}?siteId=${process.env.NEXT_PUBLIC_API_URL_SITEID}`
      );
      ...
      const contentResponse = await axios.get(
        `${process.env.NEXT_PUBLIC_API_URL_CLIENTE}/api/v1/banners/${process.env.NEXT_PUBLIC_GALERIA02_ID}?siteId=${process.env.NEXT_PUBLIC_API_URL_SITEID}`
      );
