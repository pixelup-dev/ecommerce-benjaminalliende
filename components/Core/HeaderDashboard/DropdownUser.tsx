  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        className={`absolute right-0 mt-6 pt-2 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark ${
