...
function TablaClientes() {
  ...
  // Filtrar los pedidos para eliminar correos electrónicos duplicados
  const filteredPedidos = pedidos.filter(
    (pedido: any, index: any, self: any) =>
      index ===
      self.findIndex((p: any) => p.customer.email === pedido.customer.email)
  );
          ...
          <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
              ...
              <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                <button
                  type="button"
                  className="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-2 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
                >
                  <svg
                ...
                <tbody>
                  {filteredPedidos.map((pedido: any, index: number) => (
                    ...
                    >
                      ...
                      <td className="px-2 py-3">{pedido.deliveryType.code}</td>
                      <td className="px-2 py-3">{pedido.totals.totalAmount}</td>
                      <td className="px-2 py-3">
